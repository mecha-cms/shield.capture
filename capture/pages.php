...
<main>
  ...
  <article id="page-<?php echo $page->id; ?>">
    <figure>
      ...
      <p><a href="<?php echo $page->url; ?>"><img alt="" src="<?php echo To::thumbnail($page->image, $i = 18 * 20, $i) ?: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7'; ?>"></a></p>
      <?php if ($c): ?>
